...
class AuthGate extends ConsumerWidget {
  ...
  static bool get _supabaseConfigured {
    try {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Offline/demo startup has no auth stream to await. Keep the app usable
    // instead of trapping headless runners on a loading or login screen.
    if (!_supabaseConfigured) return const MainNavigation();
